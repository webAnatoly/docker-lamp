...
if ( ! function_exists( 'empty_setup' ) ) :
	...
	function empty_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'empty_custom_background_args', array(
...
function register_my_scripts() {
	...
	wp_enqueue_script( 'myMain__range-slider-data', get_template_directory_uri() . '/js/main__range-slider-data.js', array(), '1.0', true );
